 ...
 * request.getServerPort()=9090
 * request.getRequestURL()=http://localhost:9090/ch2/requestInfo
 * request.getRequestURI()=/ch2/requestInfo
 * request.getContextPath()=/ch2
 * request.getServletPath()=/requestInfo
 * request.getQueryString()=null
 * request.getLocalName()=0:0:0:0:0:0:0:1 -> local에서 실행하여 정상 IP 출력이 안됨. AWS에서 실행시 정상 IP 출력
 * request.getLocalPort()=9090
 * request.getRemoteAddr()=0:0:0:0:0:0:0:1 -> local에서 실행하여 정상 IP 출력이 안됨. AWS에서 실행시 정상 IP 출력
 * request.getRemoteHost()=0:0:0:0:0:0:0:1 -> local에서 실행하여 정상 IP 출력이 안됨. AWS에서 실행시 정상 IP 출력
 * request.getRemotePort()=52185
 */
