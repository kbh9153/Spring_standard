...
public class RequestMessage {
	...
	public void main(HttpServletRequest request) throws Exception {
		...
		// 1. request line
		String requestLine = request.getMethod();       // GET 또는 POST (요청 메소드 타입)
		requestLine += " " + request.getRequestURI();   // /ch2/requestMessage -> URI
...
//		System.out.println("content length="+CONTENT_LENGTH);
		...
		if(CONTENT_LENGTH > 0) {	// HTTP body가 있을 경우 출력
